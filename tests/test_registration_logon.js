// File: jobs-ejs/tests/test_registration_logon.js
...
describe("tests for registration and logon", function () {
    it("should get the registration page", async () => {
        ...
        const req = request(app).get("/sessions/register").send();
        const res = await req;
    ...
    it("should register the user", async () => {
        ...
        expect(res).to.have.status(200);
        expect(res).to.have.property("text");
        // Registration redirects to index page
    ...
    it("should log the user off", async () => {
        ...
        expect(res).to.have.status(200);
        expect(res).to.have.property("text");
        expect(res.text).to.include("Click here to log on");
    });
});